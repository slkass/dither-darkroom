...
export const FILTERS: Record<string, Definition> = {
  ...
  music: {
    ...
    fields: [
      ...
      number('refraction', '边缘折射'),
      number('thickness', '玻璃厚度'),
      number('dispersion', '边缘色散'),
      number('highlight', '镜面高光'),
      number('light', '光照方向', -180, 180, '°'),
      select('textTone', '文字与控件', [
        ['auto', '自动适配明暗'],
        ['light', '浅色'],
        ['dark', '深色'],
      ]),
      number('blur', '背景模糊', 0, 100),
